...
def _seed_ingredientes(session: Session) -> dict[str, Ingrediente]:
    ...
    defs = [
        ("Queso mozzarella",  "Mozzarella entera",              True,  5000.0, 20.0,   "g"),
        ("Salsa de tomate",   "Salsa casera de tomate",          False, 8000.0,  3.0,  "mL"),
        ("Base de pizza",     "Prepizza cruda lista para usar",  True,    15.0, 500.0,  "u"),
        ("Lechuga",           "Lechuga fresca",                  False, 3000.0,  5.0,   "g"),
        ("Carne vacuna",      "Medallón de carne molida",        False, 5000.0, 35.0,   "g"),
        ("Pan de hamburguesa","Pan brioche",                     True,    20.0, 200.0,  "u"),
        ("Mayonesa",          "Mayonesa casera",                 False, 2000.0,  8.0,  "mL"),
        ("Queso cheddar",     "Fetas de cheddar",                True,  3000.0, 18.0,   "g"),
        ("Coca Cola 500mL",   "Botella de Coca Cola",            False,   50.0, 600.0,  "u"),
        ("Agua mineral 500mL","Botella de agua sin gas",         False,   80.0, 200.0,  "u"),
        ("Jamón cocido",      "Fetas de jamón",                  False, 4000.0, 25.0,   "g"),
        ("Huevo",             "Huevo fresco",                    True,   100.0, 150.0,  "u"),
        ("Aceitunas",         "Aceitunas verdes",                False, 2000.0, 10.0,   "g"),
        ("Cerveza 1L",        "Botella cerveza",                 False,   60.0, 1200.0, "u"),
        ("Jugo de naranja",   "Jugo natural",                    False, 5000.0,  4.0,  "mL"),
        ("Helado vainilla",   "Helado artesanal",                True,  3000.0, 12.0,   "g"),
        ("Pan lactal",        "Pan para sandwich",               True,    30.0, 180.0,  "u"),
        ("Tomate",            "Tomate fresco",                   False, 4000.0,  6.0,   "g"),
    ]
